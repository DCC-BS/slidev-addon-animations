...
import type { AnimationTarget, AnimatableObject } from '../types/animation.js'
...
describe('animationHelpers', () => {
  ...
  describe('createAnimationTarget', () => {
    it('should create an animation target', () => {
      ...
      const animTarget = createAnimationTarget(target, initialState, steps)
  ...
  describe('initializeTargets', () => {
    ...
    it('should handle multiple targets', () => {
      ...
      const animTarget2 = createAnimationTarget(
        target2,
        { scale: 1 },
        [{ properties: { scale: 3 } }]
      )
  ...
  describe('calculateTotalSteps', () => {
    it('should return the maximum number of steps across all targets', () => {
      const target2 = createAnimationTarget(
        { scale: 1 },
        { scale: 1 },
        [
          { properties: { scale: 2 } },
